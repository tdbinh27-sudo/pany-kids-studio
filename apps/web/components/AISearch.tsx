...
const AI_ENGINES = [
  {
    ...
    google_login_url: 'https://www.perplexity.ai/sign-up?login-source=googleOneTap',
  ...
  },
  {
    ...
    google_login_url: 'https://auth.openai.com/log-in',
  ...
  },
  {
    ...
    color: '#C97757',
    url: 'https://claude.ai',
    google_login_url: 'https://claude.ai/login',
  ...
  },
  {
    ...
    google_login_url: 'https://accounts.google.com/ServiceLogin?service=cloudconsole&continue=https://gemini.google.com/app',
        ...
        {AI_ENGINES.map(ai => (
          <div key={ai.id} className="card-hover" style={{
            ...
            <div style={{ display: 'flex', gap: 8, alignItems: 'center', flexWrap: 'wrap' }}>
              ...
              {ai.google_login_url && (
                <a
                  href={ai.google_login_url}
                  target="_blank"
                  rel="noreferrer"
                  className="body-f btn-bounce"
                  title={L('Mở trang đăng nhập (chọn tài khoản Google)', 'Open sign-in page (pick Google account)')}
                  style={{
                    background: '#fff',
